...
def make_hull(fdata):
	...
	try: # Open the output file
		...
		data1.close()
		return len(final_vertices), volume, area	

# vertices, volume = make_hull('user1_sign1.txt')
# print(vertices, volume)